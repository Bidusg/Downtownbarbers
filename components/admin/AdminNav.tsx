...
export default function AdminNav() {
  ...
  return (
    <nav className="w-full bg-surface border-b border-line px-6 py-3 flex items-center justify-between">
      <div className="flex items-center gap-1">
        <span className="text-fg font-display text-lg tracking-[0.14em] mr-6">ADMIN</span>
        {links.map(l => {
