    ...
    <>
      ...
      <main className="bg-ink min-h-screen">
        <div className="max-w-[1440px] mx-auto px-6 lg:px-12 pt-36 pb-16">
          ...
          >
            Book din
            <span className="block font-normal italic text-cream/85">time.</span>
          </h1>
        ...
        <div className="border-t border-stroke-dark">
          <div className="max-w-[1440px] mx-auto px-6 lg:px-12 py-12 grid sm:grid-cols-3 gap-8">
            <div>
              <p className="text-forest-light text-[9px] tracking-[0.3em] font-sans mb-3">ADRESSE</p>
              <p className="text-cream font-sans text-sm">Osterhaus&apos; gate 10, 0183 Oslo</p>
            </div>
            <div>
              <p className="text-forest-light text-[9px] tracking-[0.3em] font-sans mb-3">ÅPNINGSTIDER</p>
              <p className="text-cream font-sans text-sm">Man–lør 09:00 – 19:00</p>
              <p className="text-muted font-sans text-sm">Søndag stengt</p>
            </div>
            <div>
              <p className="text-forest-light text-[9px] tracking-[0.3em] font-sans mb-3">TELEFON</p>
              <a href="tel:+4746358764" className="text-cream font-sans text-sm hover:text-forest-light transition-colors">
                +47 463 58 764
              </a>
            </div>
          </div>
