...
export default function Shop() {
  ...
  return (
    <section id="butikk" ref={ref} className="bg-accent overflow-hidden">
        ...
        <div className="grid lg:grid-cols-[1fr_1fr] gap-0 min-h-[600px] lg:min-h-[700px]">
          ...
          <div className="flex flex-col justify-center py-20 lg:py-0 lg:pr-16 xl:pr-24">
            <motion.p
              ...
              className="text-accent-fg/55 text-[9px] tracking-[0.35em] font-sans mb-8"
            >
              NETTBUTIKK
            </motion.p>
            ...
            <motion.h2
              ...
              className="font-display text-accent-fg leading-[0.88] tracking-tight mb-8"
            ...
            <motion.p
              ...
              className="text-accent-fg/65 font-sans text-[15px] leading-[1.75] max-w-[48ch] mb-10"
            >
            ...
            <motion.a
              ...
              className="inline-flex items-center gap-3 self-start px-8 py-4 bg-canvas text-fg text-[10px] tracking-[0.28em] font-sans hover:bg-surface transition-colors duration-300"
            >
              GÅ TIL BUTIKKEN
